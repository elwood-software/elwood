...
function GitHubIcon(props: React.ComponentPropsWithoutRef<'svg'>): JSX.Element {
  return (
    ...
    <header
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link
          ...
          className="group"
          aria-label="GitHub">
          <GitHubIcon className="h-6 w-6 fill-muted-foreground group-hover:fill-foreground" />
        </Link>
      </div>
    </header>
  );
